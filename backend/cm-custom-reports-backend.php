...
class CM_Custom_Reports_Backend {
    ...
    public static function cmcr_admin_menu() {
        ...
        add_submenu_page(CMCR_SLUG_NAME, 'Schedules', __('Schedules', CMCR_SLUG_NAME), 'delete_others_posts', CMCR_SLUG_NAME . '-schedules', array(__CLASS__, 'cmcr_display_page'));
        add_submenu_page(CMCR_SLUG_NAME, 'Email Templates', __('Email Templates', CMCR_SLUG_NAME), 'delete_others_posts', CMCR_SLUG_NAME . '-templates', array(__CLASS__, 'cmcr_display_page'));
    ...
    public static function cmcr_display_page() {
        ...
        switch($pageId) {
			...
			case CMCR_SLUG_NAME . '-schedules': {
				ob_start();
				include_once self::$viewsPath . 'schedules.phtml';
				$content = ob_get_clean();
				break;
			}
